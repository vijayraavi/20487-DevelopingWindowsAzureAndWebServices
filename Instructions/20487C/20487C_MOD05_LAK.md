...
7. In the **Reference Manager - BlueYonder.Companion.Controllers** dialog box, in the pane on the left side, click **Solution**. In the pane on the right side, point to **BlueYonder.BookingService.Contracts**, select the check box next to the project name, and then click **OK**.
8. **In Solution Explorer**, right-click the **BlueYonder.Companion.Host** project, click **Add**, and then click **Reference**.
9. In the **Reference Manager - BlueYonder.Companion.Host** dialog box, in the pane on the left side, click **Solution**. In the pane on the right side, point to **BlueYonder.BookingService.Contracts**, select the check box next to the project name, and then click **OK**.
