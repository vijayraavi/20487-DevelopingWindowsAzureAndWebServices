...
5. In the **Add New Item** dialog box, in the **Name** text box, enter **TripDto** (replace the existing name), and then click **Add**.
...
12. In the **Add New Item** dialog box, in the **Name** text box, enter **ReservationDto** (replace the existing name), and then click **Add**.
...
2. In the **Add New Item** dialog box, from the items list, select **Interface**, in the **Name** text box, enter **IBookingService** (replace the existing name), and then click **Add**.
...
3. In the **Reference Manager** dialog box, expand the **Assemblies** node, and then click **Framework**.
...
13. Click **Search** , and in the **Search** text box, type **Paris**. If you are prompted to allow the app to share your location, click **Yes**.
14. Wait for the app to show a list of flights from **Seattle** to **Paris**.
...
26. Hover over the *confirmationCode* variable and verify that it is now set to a random confirmation code it received from the WCF service.
