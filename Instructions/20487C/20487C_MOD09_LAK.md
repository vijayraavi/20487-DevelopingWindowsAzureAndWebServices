...
6. Locate the **BaseUri** property, and replace the **{Your Web App Name Here}** string with the name that you have inside the URL that you wrote down in the previous task.
...
14. Click **Search**, and then in the **Search** text box on the right side, type **Sea**. If you are prompted to allow the app to share your location, click **Allow**.
15. Wait for the app to show a list of flights from **Paris** to **Seattle**.
