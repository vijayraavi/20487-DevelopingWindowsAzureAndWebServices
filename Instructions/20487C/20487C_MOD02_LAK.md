...
3. In the **File name** text box, type **[repositoryroot]AllFiles\Mod02\LabFiles\begin\BlueYonder.Companion\BlueYonder.Companion.sln**, and then click **Open**.
...
4. In the **ReservationQueries** class, in the **GetReservationsWithSingleFlightWithoutLazyLoad** methos, locate the **//TODO** comment, and then add the following code below it.
