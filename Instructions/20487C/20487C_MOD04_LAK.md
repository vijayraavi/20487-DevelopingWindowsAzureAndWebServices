...
**User Account Control** dialog box, click **Yes**. Enter your email address and a password in the **Windows Security** dialog box, and then click **Sign in**. Click **Close** in the **Developers License** dialog box.
