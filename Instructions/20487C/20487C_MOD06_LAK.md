...
13. In the **Add New Project** dialog box, on the navigation pane, expand the **Installed** node. Expand the **Visual C#** node. Click the **Web** node. Select **ASP.NET Web Application (.NET Framework)** from the list of templates.
14. In the **Name** text box, type **BlueYonder.Server.Booking.WebHost**.
15. In the **Location** text box, type **[repository root]\AllFiles\20487C\Mod06\LabFiles\begin\BlueYonder.Server** and click **OK**.
16. In the **New ASP.NET Web Application** window, select the **Empty** template and click **OK**.
