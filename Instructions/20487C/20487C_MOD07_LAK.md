...
11. In the **&lt;system.serviceModel&gt;** section group, locate the **&lt;behaviors&gt;** section group and locate the **&lt;transportClientEndpointBehavior&gt;** section.
12. Substitute the **{ServiceBusRelaySASKey}** placeholder by pasting the Service Bus namespace access key that you copied in the first task.
