...
36. If you are prompted to allow the app to share your location, click **Yes**.
...
11. Click **OK**.
12. Right-click solution **BlueYonder.Companion** and point to **Add**, then click **Reference**. Select **Projects** and then add the below references:
...
17. Click **Add**, a **New Azure Function - PublishFlightUpdate** window opens.
...
28. Select **MessageHandler.cs** that is located in **[repository root]\AllFiles\20487C\Mod07\LabFiles\Assets\MessageHandler.cs** and then, click **Add**.
29. Right-click **BlueYonder.Companion.Functions** and then point to **Add**, click **Refernce**.
