...
20. In **Solution Explorer**, right-click the **BlueYonder.Companion.Host**, and then click **Publish**.
...
41. Wait for the app to show a list of flights from Seattle to Paris.
42. Click **Purchase this trip**.
