...
37. Wait for the app to show a list of flights from Seattle to Rome.
38. Select flight **Seatle to Rome**, and then click on **Purchase this trip**.
...
13. In Properties windows locate **Target framework**, select **.NET Framework 4.6.2**.
...
19. Right-click project **BlueYonder.Companion.Functions** and point to **Add**, then click **Reference**. Select **Projects** and then add the below references:
