...
2. Run the following command: **Install-Module azurerm -AllowClobber -MinimumVersion 5.4.1**.
    a. To enable the relevant version of **PowerShellGet**, in the **Administrator: Windows PowerShell** window, press **Y** when you are asked whether to install and import the Buget provider now.
    b. To install the modules from **PSGallery**, in the **Administrator: Windows PowerShell** window, press **Y** when you are asked whether you are sure you want to install.
