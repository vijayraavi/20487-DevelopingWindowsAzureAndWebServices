...
11. Click **OK**.
12. Right-click project **BlueYonder.Companion.Functions** and point to **Add**, then click **Reference**. Select **Projects** and then add the below references:
...
24. Change the signature of the **Run** method as follows:
    ...
    ```
25. Now replace the following line to the **Run** method:
    ```cs
