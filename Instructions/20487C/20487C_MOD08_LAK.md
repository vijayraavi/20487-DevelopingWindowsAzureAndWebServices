...
8. If a **Developers License** dialog box appears, click **I Agree**. If a **User Account Control** dialog box appears, click **Yes**. 
9. In the **Windows Security** dialog box, enter your email address and a password, and then click **Sign in**.
...
11. In **Solution Explorer**, under the **BlueYonder.Companion.Shared** project, double-click **Addresses.cs**.
12. Locate the **BaseUri** property, and then replace the **{AppService}** string with the name of the Azure App Service you wrote down at the beginning of this lab.
13. In **Solution Explorer**, under the **BlueYonder.Companion.Client** project, expand **Helpers**, double-click **WnsManger.cs**.
14. Locate method **Register**, and then replace the **{NotificationHubConnectionString}** with **DefaultListenSharedAccessSignature** value that you copied earlier.
...
17. If a prompt to allow the app to run in the background appears, click **Allow**.
18. To display the app bar, right-click or swipe from the bottom of the screen.  
...
19. Wait for the app to show a list of flights from Seattle to New York.
20. Click **Purchase this trip**.
21. In the **First Name** text box, enter your first name.
22. In the **Last Name** text box, enter your last name.
...
26. In the **Email Address** text box, enter your email address.
27. Click **Purchase**.
28. To close the confirmation message, click **Close**.
29. Verify that the weather forecast does not display the temperature, and displays only the Fahrenheit sign.
