...
13. In the **Add Controller** dialog box, in the **Controller name** text box, type **LocationsController**.
14. From the **Template** drop-down list, select **Web API 2 controller with actions, using Entity Framework**.
15. From the **Model class** combo box, select **Location (BlueYonder.Model)**.
16. From the **Data context class** combo box, select **BlueYonderEntities (BlueYonder.Model)**.
