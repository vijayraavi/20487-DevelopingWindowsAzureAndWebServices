...
| defaults | Create a new anonymous type by using the following code.New {   controller = &quot;locations&quot;,   action = &quot;GetWeather&quot;    } |
| constraints | Create a new anonymous type nu using the following code.new{   httpMethod = new HttpMethodConstraint(HttpMethod.Get)}  |
