...
1. In Solution Explorer, under the **BlueYonder.IntegrationTests** project, duble-click **TravelCompanionDatabaseInitializer.cs**.
...
6. Explore the results, and verify that all 16 methods have passedthe test.
