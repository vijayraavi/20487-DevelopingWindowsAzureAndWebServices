...
6. In the **Connect to Server** dialog box, in the **Server name** text box, type **SQLServerName****.database.windows.net**(Replace**SQLServerName** with the server name that you wrote down in the previous task).
...
10. In the **Import Data-tier Application** wizard, click **Next** , and thenclick **Browse**.
...
14. Select the **Use SQL Server Authentication**
...
6. In the **URL** text box, type **BlueYonderWebSite YourInitials**(Replce**YourInitials**with your initials).
