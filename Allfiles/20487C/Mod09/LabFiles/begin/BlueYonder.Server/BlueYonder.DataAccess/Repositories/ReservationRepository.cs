...
namespace BlueYonder.DataAccess.Repositories
{
    public class ReservationRepository : IReservationRepository
    {
        ...
        {
            var departTrip = GetAll().Where(r => r.DepartFlightScheduleID == tripID).Select(r => r.DepartureFlight);
            var returnTrip = GetAll().Where(r => r.ReturnFlightScheduleID == tripID).Select(r => r.ReturnFlight);
