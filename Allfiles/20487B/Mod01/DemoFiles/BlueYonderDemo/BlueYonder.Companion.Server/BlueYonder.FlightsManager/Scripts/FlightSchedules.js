$('table tr td:nth-child(2) input').datepicker({
    // dateFormat: 'dd-mm-yy'
});
$('table tr td:nth-child(3) input').timePicker();
$(".update").click(function () {
    var flightScheduleId = $(this).attr("data-id");
    var date = $(this).parent().parent().find("td input[name^='d_']").attr("value");
    var time = $(this).parent().parent().find("td input[name^='t_']").attr("value");
    var output = $(this).parent().parent().find("td[id^='o_']");
    $.get(
        $(this).attr("href") + "&date=" + date + "&time=" + time,
        function (data) {            
            $('div', output).show();
        }
    );
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFBR5afeVrd7U
// SIG // Z9v1WR1jU9g0Xek9oIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQBuRDiI2E0
// SIG // He2kdUhZDOLS0dxB4DBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQAHfZmq
// SIG // 77TWccSW9oPtJgSlQgHulDQY0vyWxOrs3z4TqwQoFxtB
// SIG // fg6xqrbGlGaa78tuIPE9y8VRlrrGyIjt0U52C3Z1uWtD
// SIG // ILvG3rPpsGQTXOov1BnrZUJ2yTon6z7aWsU/8kZ4CQ+q
// SIG // i0eq2jZ3Q0FOxJ3iAjRG4YOJxSuy+zoEsTaCJFFS+rlf
// SIG // tUb1wg7KgSaiqAhQK7yIUBBGLt6CUKz2vqsF+0UCfUMi
// SIG // hXLna/l2mcEYP5W8f7NKLSe/FTtyu/ORZI+BZAQazsL8
// SIG // Vgokt4tM29mXXh/wOtlUltCTh/0Mto2jc/gLbmFsEvBI
// SIG // jHGtXJz5mmhPaNhOCde+vFgui6dYoYICKDCCAiQGCSqG
...
// SIG // WjAjBgkqhkiG9w0BCQQxFgQUdoeNQI1eN/DccrJokcjq
// SIG // OQXv+/UwDQYJKoZIhvcNAQEFBQAEggEAUDmu9bhIGZhI
// SIG // Gl+IDT3TXiWq36suAlV+UUbhc9Z+kuC6iDLDajEBlhrp
// SIG // gf3L0/MeZtN8Zh9oZ6IauwDrThMGzlqLc4xJy5jPt9EO
// SIG // 5+Gml0Q2GOAeUF7VvtqAmm+Plx6lGPXI4OtgsDsZB5/x
// SIG // +Gjn3CZcikLtAJKx1yus75D4QaH3nccyeFugyP0jifj1
// SIG // 8Lws6ySZSZuoqKzuzP5E7RPwlHk4FWjWoT8wh0DcKkcE
// SIG // Byso7kv03iFw7OfINfCHow4qPrc6VU4e7RmpEqZIQ6kB
// SIG // pLatj0QcczToBVSkDBlW4ksbZjwzgQzNSXMZ+8p2icoB
// SIG // pR+x0b7WWAy+Xdj4gIUsGw==
