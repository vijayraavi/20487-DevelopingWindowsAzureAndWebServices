$cert = get-childitem -path cert:\LocalMachine\My | where {$_.Subject -match 'CN\=DemoCert'}

$certThumb = $cert.Thumbprint
$sslGuid = "{" + ([System.Guid]::NewGuid().toString()) + "}" 

## UnRegister the SSL certificate (just in case)
netsh http delete sslcert ipport=0.0.0.0:8081

## Register the SSL certificate 
netsh http add sslcert ipport=0.0.0.0:8081 certhash=$certThumb appid=$sslGuid 

# SIG # Begin signature block
# MIIaagYJKoZIhvcNAQcCoIIaWzCCGlcCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+HBk8ILHmQVC4+0i6bnuaJAV
# KMKgghUvMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# SIb3DQEJBDEWBBRTMvoMXpjiqnejtJHPQ12zFgC34zBeBgorBgEEAYI3AgEMMVAw
...
# AQCRnzQqL13DZ77FFso/svHsaDu+VTsz3OHkr3TMn8B6qiQeIsau8cSJSMqvjtR2
# +P0R/0fr55jkK/l2Sf/ClUxaRIB3PATZViF8Eja+vDskp63r7pUGwSJ4MbjcJEt3
# myiYiKjE9q8RgX0MSqvnIhzNTlJSepwb+Q0Ju5iTaROOZL0tMym8I0m3HIKp0GSM
# ogdnsPaKSTvJ2uF3m+gzWrqvQ/6r/kj/uSiim8TUYYRbi/xISrcC4vz8zB/l+J9y
# l/23+BLjqxMuFY0dC/v+NS8hhcg9b5MRN6Cd1A9Pcb4G5ZTDV/0TE781eyQAfZav
# NwvJbEr1GP37CQoEAAshhqeCoYICKDCCAiQGCSqGSIb3DQEJBjGCAhUwggIRAgEB
...
# 9w0BCQUxDxcNMTMwMTE5MDAzMDMzWjAjBgkqhkiG9w0BCQQxFgQUz8KVHmt8IXdK
# Ddot5OqNdzKxLCUwDQYJKoZIhvcNAQEFBQAEggEAjJ0qN2qyQ/w/e0IwmMU2TKGU
# 2v7mopOShHTTqvNscs2WZWhkFNCoKnaBWLtcYROdMavFcLZDk02JKBHDmIM5mWdJ
# 1iR7IYAsNIuE299VI2bI30u6wmoabyb/XrLhY3b/Z1Raj97HwyWhR+3HleJrjNxe
# A0Xq84Zme4WyGlSx4RaQfCm/kZxB8zdKa+DutcabMjoZDc1cv/pKdoyUThliLXPm
# zc/7gVxoywrIC3VWH6B9Lis+XKZg6vJ+GPR5HQwOBAivA/dp1Ng6Gm1RCZn6aRzY
# PNsIP+gO4Y+p+r0cEvEk9J96wSg35PJjkeyTLZ1FDDrHAW9wDnHOWYYf2XvYeQ==
