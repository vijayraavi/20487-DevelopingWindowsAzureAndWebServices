...
namespace BlueYonder.Companion.Controllers
{
    public class FlightsController : ApiController
    {
                                       ...
                                       DateTime? date = null)
        {
            ...
            List<FlightWithSchedulesDTO> routesWithSchedules = null;

            // TODO: Place cache initialization here
            DataCacheFactory cacheFactory = new DataCacheFactory();
            DataCache cache = cacheFactory.GetDefaultCache();

            // TODO: Place cache check here
            ...
            HttpResponseMessage response = Request.CreateResponse(HttpStatusCode.OK, routesWithSchedules);
            return response;
        }
