...
namespace ServiceBusQueue
{
    class Program
    {
        ...
        private static string ServiceBusNamespace = "{ServiceBusNamespace}";

        private static string ServiceIdentityName1 = "owner";
        private static string ServiceIdentityKey1 = "{Password}";

        private static string ServiceIdentity2 = "QueueClient";
        private static string ServiceIdentityKey2 = "{Password}";        
